...
<div align="left">  
	<img src="../../images/jvm/java对象访问定位模型.jpg" width="600px" height="500px"/>
</div>
...
<div align="left">  
	<img src="../../images/jvm/java 值传递模型.jpg" width="700px" height="500px"/>
</div>

2）使用类ReferenceObj的实例变量obj，通过swapByReference()进行的是引用传递的方式，具体的内存模型如下：

<div align="left">  
	<img src="../../images/jvm/java 引用传递模型.jpg" width="700px" height="500px"/>
</div>
