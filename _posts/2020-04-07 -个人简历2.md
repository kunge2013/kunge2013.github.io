...
# 工作经历
 ...
 - 2018.08 - 2019.10 武汉青柚时光  java 高级开发工程师
 - 2017.04 - 2018.08 贵仁科技 java 开发工程师
...
-	7.改造redkale框架使之支持国际化,通过拦截器拦截http相关接口，根据请求头LOCAL语言选择对应的语言描述
-	8.负责消息加密方案选取 ，消息采用ECC 进行加密,保证传输的安全性
