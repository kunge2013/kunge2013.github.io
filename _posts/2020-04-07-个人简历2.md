...
- 2.掌握并熟练应用Java、Jsp、Servlet、Html、css+div布局、Js脚本、Android基础开发,linux常用命令，Json数据传输。
...
-   5.熟练使用 springcloud netflex 相关组件 (Eureka, Ribbon, FeignClient, gateway)
-   4.熟练使用Maven项目管理工具以及常用命令
-   5.熟练使用百度地图,百度ocr识别，阿里云 实人认证，阿里云短信  API应用于项目
-   6.熟练使用Quartz 定时任务 应用技术
-   7.熟练使用Redis、ignite 存储缓存中间件
-   8.熟练使用 Activemq
-   9.熟练使用单元测试Junit工具
-   10.熟练使用log4j，sl4j 日志框架
-   11.熟练使用Oracle11g, MySql8，SqlServer2012，MongDb, elasticsearch5.6 等数据库开发语言
-   12.熟练使用Birt、poi等报表工具
-   13.熟练使用Jsp、EasyUi、bootstrap、Jquery、ECharts、kendo UI、Ajaxs、Velocity、LODOP6.0、Ztree，Freemarker、KindEditor,UNIAPP 等前端开发技术，了解angularJs，vue 开发技术
-   14.熟练使用 Inject IDEA、Eclipse、netbean 等开发工具
-   15.熟练使用 Linux操作系统命令，基于linux 部署 redis, nginx, mysql 等基础环境
-   16.熟悉使用Postman插件调试接口, 以及 遵循 swagger规范，进行接口调试或联调
-   17.熟练使用UML、SVN、GIT等开发辅助工具
-   18.熟练使用SpringBoot，并基于springboot 快速搭建 springcloud 基础开发环境
-   19.熟练使用 tcp/ip 框架 (mina2,netty4)
-   20.熟练使用jdk原生的nio ，多线程，线程池
